...
Resource Allocation Summary:
    ...
    VSU terminals (2): VDD (Pin 19), VCC (Pin 17)
        → 4156B VSU21, VSU22
...
COMPUTE_TERMINALS = {
    ...
    "TRIM1": TerminalConfig(
        ...
        instrument=InstrumentType.IV5270B,
        channel=5,
        description="Trim current 1 - 5270B MP SMU - linked with TRIM2 (Pin 22)"
    ),
    "TRIM2": TerminalConfig(
        ...
        instrument=InstrumentType.IV5270B,
        channel=6,
        description="Trim current 2 - 5270B MP SMU - linked with TRIM1 (Pin 24)"
    ),
    "F11": TerminalConfig(
        terminal="F11",
        measurement_type=MeasurementType.I,
    ...
    "KGAIN1": TerminalConfig(
        ...
        instrument=InstrumentType.IV4156B,
        channel=2,
        description="KGAIN1 current - 4156B SMU - linked with KGAIN2 (Pin 14)"
    ),
    "KGAIN2": TerminalConfig(
        ...
        instrument=InstrumentType.IV4156B,
        channel=3,
        description="KGAIN2 current - 4156B SMU - linked with KGAIN1 (Pin 15)"
    ),
    ...
    "VDD": TerminalConfig(
        ...
        instrument=InstrumentType.IV4156B,
        channel=21,
        description="Power supply voltage source - 4156B VSU1 (Pin 19)"
    ),
    "VCC": TerminalConfig(
        terminal="VCC",
        measurement_type=MeasurementType.VSU,
        instrument=InstrumentType.IV4156B,
        channel=22,
        description="VCC voltage source - 4156B VSU2 (Pin 17)"
    ),
    ...
    "ERASE_PROG": TerminalConfig(
        ...
        channel=1,
        description="Erase/Program DC voltage - 81104A Channel 1 (DC mode, never triggered) (Pin 13)"
    ),
}
